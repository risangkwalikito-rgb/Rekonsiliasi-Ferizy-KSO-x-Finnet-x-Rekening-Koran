...
if uploaded_file:
    ...
    if st.button("Proses rekonsiliasi", type="primary"):
        ...
        top4.metric("Payment method belum match", f"{unmatched_df['payment_method_raw'].nunique() if not unmatched_df.empty else 0:,}")
